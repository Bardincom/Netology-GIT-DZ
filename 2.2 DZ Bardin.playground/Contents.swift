...
//MARK: Задача 4
// Наш отдел HR проводит исследование зарплат. Нам нужно проанализировать разницу в зарплатах сотрудников. Используя данные из задачи №.3, составьте операции сравнения и выведите в консоль результат выполнения (все данные о зарплате берите после повышения):


// Так как утверждение верное что зарплата Младшего разработчика выше Стажера получим True
print("Зарплата первого больше зарплаты третьего: \(juniorDeveloperSalary > internDeveloperSalary)")

// Так как утверждение верное что зарплата Стажера меньше Младшего разработчика получим True
print("Зарплата второго меньше зарплаты первого: \(internDeveloperSalary < juniorDeveloperSalary)")

// В данной проверке должно выполниться хотябы одно условие, мы попадаем в верное утверждение в первой части проверки результат будет True
print("Зарплата первого больше зарплаты второго ИЛИ зарплата третьего меньше зарплаты второго: \(juniorDeveloperSalary > internDeveloperSalary || hrManagerSalary < internDeveloperSalary)")

// Проверяя данное условие поставлена четкая задача, чтобы первое И второе условие выполнялось, так как условия сравнения небыли выполнены на выходе получаем false
print("Зарплата третьего меньше зарплаты первого И зарплата второго больше зарплаты первого: \(hrManagerSalary < juniorDeveloperSalary && internDeveloperSalary > juniorDeveloperSalary)")
